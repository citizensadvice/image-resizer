...
```bash
my-application$ sam local invoke ImageResizerHandlerFunction --event events/event-s3.json --parameter-overrides AppBucketName=test-bucket
```
